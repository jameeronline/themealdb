        ...
        <div className="relative mb-6">
          <Form className="">
            ...
            <input
              ...
              className="peer relative h-12 w-full rounded border border-primary-200 px-4 pl-12 text-slate-500 outline-none transition-all autofill:bg-white invalid:border-pink-500 invalid:text-pink-500 focus:border-primary-300 focus:outline-none invalid:focus:border-pink-500 focus-visible:outline-none disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-400"
